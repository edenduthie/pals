# ModelDiurnalCycleQle.R
# Variable requirements: Qle
#
# This script plots the average diurnal cycle of latent 
# heat for both a model output and observation time series.
...
varname=QleNames
units=QleUnits
ytext = expression("Latent heat flux  W/"~m^{2})
