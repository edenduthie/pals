...
$(document).ready(function(){ 
    ...
    $("#dataSetSelect").change(function(){
        ...
        displaySelectOptions();
        refilterDisplay();
        if( filterDataSet.length > 0 ) displayVersionSelect(filterDataSet);
        else $("#versionSelect").hide();
...
function displaySelectOptions(resetModelOutput)
{	
...
function displayFilters()
{
    ...
    fillSelectOptionsOld("dataSetSelect",dataSets,'name','id',"--DataSet--");
}
...
<p>
This plot is a smoothed time series of evaporative fraction - latent heat flux divided by the sum of latent and sensible heat fluxes (Qle/(Qle+Qh)). At current settings, it shows the moving average of a 30-day window, and only includes times when both fluxes are positive (daytime).
</p>
<p>
...
<h3>Diurnal Cycle</h3>
<p>
This plot shows the average diurnal cycle of a particular variable. Four separate panels are shown, one for each season, and results include all years of the dataset.
</p>
<p>
...
<h3>Annual Cycle</h3>
<p>
This graph shows a line plot of the twelve average monthly values of a variable, averaging over all years of the given data set.
</p>
<p>
...
<p>
<b>Interpretation</b>: This plot provides a way to see the relationship between these three performance measures, as well as how they change from per-time-step to daily to monthly averages, giving an indication of how performance is different at different time scales.
</p>
<p>
<b>Requirements</b>: any variable which varies at each model time step 
</p>
...
<h3>Pdf</h3>
<p>
This shows the approximate density of values of a particular variable across its entire range in both the modelled and observed cases, with their overlap shaded in grey and reported as a percentage.
</p>
<p>
...
<h3>Timeseries</h3>
<p>
This simply shows a smoothed time series of a variables (14-day running mean by default) across the entire data set.
</p>
<p>
