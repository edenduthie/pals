...
<head>
	...
	<s:form action="DataSetAction_save">
	...
	<div id="latString" class="left-form-field short">
	...
	<br>
	<div id="lonString" class="left-form-field short">
	...
	<s:textfield name="towerHeight" label="Measurement Height (m)" />
	...
	<a class='pbut-link' href='javascript:void(0)' onclick='submit()'>Create New Data Set</a>
